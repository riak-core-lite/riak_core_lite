...
prune_small_test() ->
    ...
    SmallVC = [{<<"1">>, {1, OldTime}}, {<<"2">>, {2, OldTime}}, {<<"3">>, {3, OldTime}}],
...
prune_young_test() ->
    ...
    Now = riak_core_util:moment(),
    NewTime = Now - 1,
    VC = [{<<"1">>, {1, NewTime}}, {<<"2">>, {2, NewTime}}, {<<"3">>, {3, NewTime}}],
...
prune_big_test() ->
    ...
    NewTime = Now - 1000,
    VC = [{<<"1">>, {1, NewTime}}, {<<"2">>, {2, NewTime}}, {<<"3">>, {3, NewTime}}],
    Props = [{small_vclock, 1}, {young_vclock, 1}, {big_vclock, 2}, {old_vclock, 100000}],
...
prune_old_test() ->
    ...
    NewTime = Now - 1000,
    OldTime = Now - 100000,
    VC = [{<<"1">>, {1, NewTime}}, {<<"2">>, {2, OldTime}}, {<<"3">>, {3, OldTime}}],
    Props = [{small_vclock, 1}, {young_vclock, 1}, {big_vclock, 2}, {old_vclock, 10000}],
